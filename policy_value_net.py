...
class PolicyValueNet():
    ...
    def create_policy_value_net(self):
        ...
        self.policy_net = lasagne.layers.DenseLayer(policy_net, num_units=792,
    ...
    def policy_value_fn(self, board:Board):
        ...
        legal_moves = vertex_to_move_fn(legal_positions)
        act_probs = zip(legal_moves, act_probs.flatten()[legal_moves])
